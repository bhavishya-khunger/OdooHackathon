  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 font-sans">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-lg bg-bg-surface border border-border-base rounded-2xl shadow-2xl overflow-hidden"
      >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 sm:col-span-1">
              ...
              <input 
                ...
                className="w-full px-4 py-2.5 bg-bg-base border border-border-strong rounded-xl text-[13px] text-text-primary placeholder:text-[#555] focus:outline-none focus:border-border-focus font-mono transition-colors"
              />
            </div>
            <div className="col-span-2 sm:col-span-1">
