  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 font-sans">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-sm bg-bg-surface border border-border-base rounded-2xl shadow-2xl overflow-hidden p-6 text-center transition-colors duration-300"
      >
        <div className="mx-auto w-12 h-12 bg-red-100 dark:bg-[#2a1215] text-danger-base flex items-center justify-center rounded-full mb-4 transition-colors duration-300">
          <Trash2 className="h-5 w-5" />
        </div>
        <h2 className="text-lg font-semibold text-text-primary mb-2 transition-colors duration-300">
          Delete Asset?
        </h2>
        <p className="text-text-secondary mb-6 text-[13px] transition-colors duration-300">
